...
import "./heart.scss";
const HeartSvg = ({id}) => {
    return (<svg id={id} width="30" height="30" viewBox="0 0 150 130" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const Heart = () => {
    ...
    return (
        <div className="containerHeart">
            <button className="buttonHeart" onClick={handleClick}>
                <HeartSvg id={isFavorite ?  'favorite-stroke': 'favorite-filled'}/>
            </button>
        </div>)
}
